...
- Purpose: monitor patients, review metrics (glucose, ketones, GKI), adjust protocols, visualize protocol flows (React Flow likely).
...
2) Python for ML + analytics + (optionally) FastAPI backend.
