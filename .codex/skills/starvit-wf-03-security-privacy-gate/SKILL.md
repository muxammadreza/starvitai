---
name: starvit-wf-03-security-privacy-gate
description: Run for any change that touches -> PHI boundary, auth/RBAC, external integrations, data export, ML/agent actions, or pipeline cross-zone movement.
---
