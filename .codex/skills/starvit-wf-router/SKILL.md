---
name: starvit-wf-router
description: If the user request is *pure Q&A* (no implied repo changes), answer normally and stop. Otherwise continue -> this is an implementation request and must be routed.
---
...
Open and use:
- `.codex/skills/starvit-router/references/router_map.yml`
