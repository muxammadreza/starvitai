---
name: starvit-rule-04-project-scope-scientific-context
description: Starvit is a **clinician‑supervised metabolic‑therapy support platform** (oncology first; diabetes/metabolic disease later) with strict PHI controls and a **de‑identified research/ML layer**.
---
