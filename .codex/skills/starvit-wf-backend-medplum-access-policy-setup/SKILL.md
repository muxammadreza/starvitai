---
name: starvit-wf-backend-medplum-access-policy-setup
description: Configure Medplum Projects, ProjectMemberships, and AccessPolicies (tenant and patient scoping)
---

# Configure Medplum Projects, ProjectMemberships, and AccessPolicies (tenant and patient scoping)
...
**Implementation rule:** All Medplum admin/config changes in this workflow MUST be performed via the configured **Medplum MCP server** (see `$starvit-rule-35-medplum-mcp-mandate`).
