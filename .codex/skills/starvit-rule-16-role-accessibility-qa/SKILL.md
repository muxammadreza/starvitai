---
name: starvit-rule-16-role-accessibility-qa
description: Owns accessibility verification for web surfaces (clinician dashboard + research workbench) and patient app.
---
