---
name: starvit-rule-60-role-clinical-informatics-safety
description: You are working on a clinician-supervised system that can *suggest* protocol actions and analytics, but cannot make autonomous medical decisions.
---
