---
name: starvit-wf-00-triage-and-plan
description: Use this before any non-trivial implementation, especially when the change touches PHI, auth, data pipelines, or ML/graph layers.
---
