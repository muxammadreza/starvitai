---
name: starvit-rule-01-security-terminal-browser
description: This repo uses a high-automation workflow style. That creates **real** risk - prompt injection (malicious instructions in issues/docs/webpages), - accidental destructive commands, - secrets leakage, - PHI boundary violations.
---
