---
name: starvit-wf-science-evidence-ingestion
description: Scientific evidence ingestion → structured evidence cards → feature/protocol mapping
---

# Scientific evidence ingestion → structured evidence cards → feature/protocol mapping
...
- `$starvit-wf-clinical-evidence-card`
